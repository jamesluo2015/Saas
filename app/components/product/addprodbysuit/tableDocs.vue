...
<div class="col-md-12 pd_l0 mg_t20 clearfix select_dropdown bd_bD_d9 pd_b20" v-for="(index, item) in products">
    ...
    <div class="col-md-8">
        <div class="bd_bd9 h40 lineH40 clearfix">
            ...
            <span class="col_767676 pull-left mg-l40">零件编号：<a href="javascript:void(0)" class="saas_add mg_l0">查看</a></span>
        ...
        <div class="row">
            ...
            <div class=" pd_l0 mg_t20 clearfix select_dropdown pull-left w300">
                ...
                <lable v-else>{{item.ProdBrandName||"其它"}}</label>
            </div>
            <div class=" pd_l0 mg_t20 clearfix pd_b20 select_dropdown pull-left w300">
                ...
                <lable v-else>{{item.DealerNo}}</label>
            </div>
            <div class="cl"></div>
            ...
            <div class="pd_l0 mg_t10 clearfix select_dropdown pull-left w300">
                ...
                <lable v-else class="control-label pull-left">{{item.StockCount}}</label>
            </div>
        </div>
        <div class="col-md-12 mg_t30">
            <a href="#" v-if="item.isupdate" class="btn_red bg8 auto f16 w200 h40" @click='save(index)'>保&nbsp;存</a>
