...
<div class="right_contain1">
    <div class="row">
        <div class="col-md-12 pd_l0 mg_t10 clearfix pd_b20 bdB_d0d0d0">
            ...
            <span class="mg_l30">结算周期：{{firdate}}&nbsp;至&nbsp;{{lastdate}}</span>
        ...
        <div class="col-md-12 pd_l0 mg_t30 mg_b20 clearfix pd_b20 h60 this_bill">
            ...
            <span class="f26 col_d50707">{{list[0]}}</span>
            <span class="f20 fB fS col_767676 mg_l5 mg_r5">=</span>
            <span class="f26 col_d50707"><em class="fS">{{list[1]}}</em><em class="col_010101 fS fN f14">【货款】</em></span>
            <span class="f20 fB fS col_767676 mg_l5 mg_r5">-</span>
            <span class="f26 col_77b530"><em class="fS">{{list[2]}}</em><em class="col_010101 fS fN f14">【佣金】</em></span>
            <span class="f20 fB fS col_767676 mg_l5 mg_r5">-</span>
            <span class="f26 col_77b530"><em class="fS">{{list[3]}}</em><em class="col_010101 fS fN f14">【代付运费】</em></span>
            <span class="f20 fB fS col_767676 mg_l5 mg_r5">-</span>
            <span class="f26 col_77b530"><em class="fS">{{list[4]}}</em><em class="col_010101 fS fN f14">【其它】</em></span>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
          firdate:date.getCurrentMonthFirst(),
          lastdate:date.getCurrentMonthLast(),
