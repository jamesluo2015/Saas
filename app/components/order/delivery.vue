    ...
    <div class="row">
        <div class="col-md-12 pd_l0 pd_r0 mg_r0">
            <div class="bdB_d0d0d0 lineH30 pd_b10 clearfix">
                ...
                <span class="mg_l110 pull-left">订单状态：{{model.OrderStatus>2?"待发货":"已发货"}}</span>
            ...
            <div class="mg_1">
                ...
                <div class="col-md-12 clearfix select_dropdown">
                    <a href="#" class="btn_red bg8 f14 w120 h30 mg_t20 mg_b20 pull-left mg-l40" @click="commit">确认发货</a>
...
export default {
    ...
    data() {
      return{
        express: [],
        expresslist: [{label:"顺丰",value:"0"}],
        expressno: "",
        houselist: [{label:"北京库区",value:"0"}],
        house:[]
      }
    },
    ready(){
